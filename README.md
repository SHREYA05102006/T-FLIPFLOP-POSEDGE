...
**PROGRAM**
```
/* Program for flipflops and verify its truth table in quartus using Verilog programming. Developed by:v.shreya RegisterNumber:24000632
*/
```
```
...
![Screenshot (198)](https://github.com/user-attachments/assets/32c6db80-a286-478b-9b7e-d607c93735eb)


**TIMING DIGRAMS FOR FLIP FLOPS**

![Screenshot (199)](https://github.com/user-attachments/assets/edb6b4be-1255-4cf2-9965-a239371f98d2)
